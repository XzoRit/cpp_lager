...
BOOST_AUTO_TEST_CASE(update_view_model)
{
    ...
    const auto b_model{xzr::counter::view::model::update(a_model, xzr::counter::view::model::action::increment{})};
    BOOST_CHECK_EQUAL(b_model.which_colour, xzr::counter::view::model::colour::green);

    const auto c_model{xzr::counter::view::model::update(b_model, xzr::counter::view::model::action::decrement{})};
    BOOST_CHECK_EQUAL(c_model.which_colour, xzr::counter::view::model::colour::grey);

    const auto d_model{xzr::counter::view::model::update(c_model, xzr::counter::view::model::action::decrement{})};
    BOOST_CHECK_EQUAL(d_model.which_colour, xzr::counter::view::model::colour::red);

    const auto e_model{xzr::counter::view::model::update(d_model, xzr::counter::view::model::action::reset{0})};
