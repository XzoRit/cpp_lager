...
//  2019-02-11: OpenGL: Projecting clipping rectangles correctly using draw_data->FramebufferScale to allow
//  multi-viewports for retina display. 2018-11-30: Misc: Setting up io.BackendRendererName so it can be displayed in
//  the About Window. 2018-08-03: OpenGL: Disabling/restoring GL_LIGHTING and GL_COLOR_MATERIAL to increase
//  compatibility with legacy OpenGL applications. 2018-06-08: Misc: Extracted imgui_impl_opengl2.cpp/.h away from the
//  old combined GLFW/SDL+OpenGL2 examples. 2018-06-08: OpenGL: Use draw_data->DisplayPos and draw_data->DisplaySize to
//  setup projection matrix and clipping rectangle. 2018-02-16: Misc: Obsoleted the io.RenderDrawListsFn callback and
//  exposed ImGui_ImplOpenGL2_RenderDrawData() in the .h file so you can call it yourself. 2017-09-01: OpenGL: Save and
//  restore current polygon mode. 2016-09-10: OpenGL: Uploading font texture as RGBA32 to increase compatibility with
//  users shaders (not ideal). 2016-09-05: OpenGL: Fixed save and restore of current scissor rectangle.
...
static void ImGui_ImplOpenGL2_SetupRenderState(ImDrawData *draw_data, int fb_width, int fb_height)
{
    ...
    // imgui_impl_opengl3.cpp!!), you may need to backup/reset/restore current shader using the lines below. DO NOT
    // MODIFY THIS FILE! Add the code in your calling function:
    //  GLint last_program;
