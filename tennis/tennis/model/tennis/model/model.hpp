...
template <class player_id> struct player
{
...
{
    return std::make_tuple(a.leading_player, a.points_other_player) ==
           std::make_tuple(b.leading_player, b.points_other_player);
}
inline bool operator!=(const game::forty& a, const game::forty& b)
{
    return !(a == b);
...
template <class player_scored> struct create_deuce_or_winner_game;
template <> struct create_deuce_or_winner_game<action::player_1_scored>
{
...
template <> struct create_deuce_or_winner_game<action::player_2_scored>
{
...
template <class scoring_player> struct update_game_state
{
...
{
    template <class scoring_player> game operator()(scoring_player) const
    {
